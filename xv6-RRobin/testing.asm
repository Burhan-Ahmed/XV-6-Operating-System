   ...
   e:	31 db                	xor    %ebx,%ebx
{
  ...
  1b:	78 28                	js     45 <main+0x45>
        {
            printf(1, "Fork failed\n");
            exit();
        }
        else if (pid == 0)
  1d:	74 39                	je     58 <main+0x58>
    for (i = 0; i < 5; i++)
  1f:	83 c3 01             	add    $0x1,%ebx
  22:	83 fb 05             	cmp    $0x5,%ebx
  25:	75 ed                	jne    14 <main+0x14>
    ...
    {
        wait();
  27:	e8 ef 02 00 00       	call   31b <wait>
  2c:	e8 ea 02 00 00       	call   31b <wait>
  31:	e8 e5 02 00 00       	call   31b <wait>
  36:	e8 e0 02 00 00       	call   31b <wait>
  3b:	e8 db 02 00 00       	call   31b <wait>
    }

    exit();
  40:	e8 ce 02 00 00       	call   313 <exit>
            printf(1, "Fork failed\n");
  45:	51                   	push   %ecx
  46:	51                   	push   %ecx
  47:	68 98 07 00 00       	push   $0x798
  4c:	6a 01                	push   $0x1
  4e:	e8 1d 04 00 00       	call   470 <printf>
            exit();
  53:	e8 bb 02 00 00       	call   313 <exit>
            if (i % 2 == 0)
  58:	f6 c3 01             	test   $0x1,%bl
  5b:	75 44                	jne    a1 <main+0xa1>
                printf(1, "Process %d running with PID %d\n", i, getpid());
  5d:	e8 31 03 00 00       	call   393 <getpid>
  62:	50                   	push   %eax
  63:	53                   	push   %ebx
  ...
  7a:	ba 00 2d 31 01       	mov    $0x1312d00,%edx
  7f:	90                   	nop
                    x = x + 1;
  ...
  89:	83 ea 01             	sub    $0x1,%edx
  8c:	75 f2                	jne    80 <main+0x80>
                printf(1, "Process %d ended\n", i);
  8e:	52                   	push   %edx
  8f:	53                   	push   %ebx
  90:	68 a5 07 00 00       	push   $0x7a5
  95:	6a 01                	push   $0x1
  97:	e8 d4 03 00 00       	call   470 <printf>
  9c:	83 c4 10             	add    $0x10,%esp
  9f:	eb 9f                	jmp    40 <main+0x40>
                printf(1, "Current Process Interrupted...\n");
  a1:	50                   	push   %eax
  a2:	50                   	push   %eax
  a3:	68 d8 07 00 00       	push   $0x7d8
  a8:	6a 01                	push   $0x1
  aa:	e8 c1 03 00 00       	call   470 <printf>
                sleep(5); // Simulate I/O work
  af:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
  b6:	e8 e8 02 00 00       	call   3a3 <sleep>
  bb:	83 c4 10             	add    $0x10,%esp
            exit();
  be:	eb 80                	jmp    40 <main+0x40>
 ...
 3cc:	89 d1                	mov    %edx,%ecx
{
 ...
 3f9:	0f b6 92 58 08 00 00 	movzbl 0x858(%edx),%edx
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e9:	ff 24 85 00 08 00 00 	jmp    *0x800(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba f8 07 00 00       	mov    $0x7f8,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 04 0b 00 00       	mov    0xb04,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 04 0b 00 00    	mov    %edx,0xb04
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 04 0b 00 00    	mov    %edx,0xb04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d 04 0b 00 00    	mov    0xb04,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d 04 0b 00 00    	mov    0xb04,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 04 0b 00 00    	mov    0xb04,%edx
 ...
 767:	0b 00 00 
    base.s.size = 0;
 76a:	bf 08 0b 00 00       	mov    $0xb08,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 0c 0b 00 00 00 	movl   $0x0,0xb0c
 782:	00 00 00 
    if(p->s.size >= nunits){
